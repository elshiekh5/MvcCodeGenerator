...
namespace SMOSampleInConsol
{
    class SqlProviderBuilder : TableFileBuilder
    {
        ...
        private new void init()
        {
            ...
            string primaryKeyParametterPattern = "\t\t\t\tmyCommand.Parameters.Add(\"@{0}\", SqlDbType.{1}).Direction = ParameterDirection.Output;\n";
           ...
           // string idParameterDecerationPattern1 = "myCommand.Parameters.Add(\"@{0}\", SqlDbType.{1}, {2});\n";
            ...
            foreach (CustomColumn c in CurrentTable.Columns)
            {
                ...
                {
                    DynamicParametersForCreate.AppendFormat(primaryKeyParametterPattern, new string[] { c.ProgramatlyName, c.SqlDbTypeString,  CurrentTable.ModelObject });
