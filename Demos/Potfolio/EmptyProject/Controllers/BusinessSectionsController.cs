...
namespace Portfolio
{
    public class BusinessSectionsController : Controller
    {
        ...
        //***********************************************************************************************
        //
        // GET: /BusinessSections/
        public ActionResult Index()
        {
              
            FlexigridViewModel flexigrid = new FlexigridViewModel("BusinessSectionsList","BusinessSectionsForm","BusinessSectionsPost", "/BusinessSections/List", "json", "Title", "asc", true, "BusinessSections Listing", true, pageSize, true, 950, 2000);
            ...
            flexigrid.DialogBoxId = "BusinessSectionsDialog";
            ...
            return View(new BusinessSectionsModel());
        ...
        //***********************************************************************************************
        [HttpPost]
        public ActionResult Update(BusinessSectionsModel BusinessSectionsObj)
        {
            //------------------------------------------
            //Check ModelState
            //------------------------------------------
            ...
            try
            {
                bool result = BusinessSectionsFactor.Update(BusinessSectionsObj);
                if (result == true)
                {
                    return List(1,25, null, null, null, null);
                }
        ...
        //***********************************************************************************************
        private JsonResult CreateFlexiJson(IEnumerable<BusinessSectionsModel> items, int page, int total)
        {
            return Json(
                    new
                    {
