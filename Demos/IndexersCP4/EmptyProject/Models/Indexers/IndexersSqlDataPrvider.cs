    ...
    public class IndexersSqlDataPrvider
    {
        ...
        public bool Create(IndexersModel IndexersObj)
        {
            ...
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
				myCommand.Parameters.Add("@IndexerID", SqlDbType.Int).Direction = ParameterDirection.Output;
				myCommand.Parameters.Add("@Name", SqlDbType.VarChar).Value = IndexersObj.Name;
				myCommand.Parameters.Add("@OwnerID", SqlDbType.Int).Value = IndexersObj.OwnerID;
        ...
        public bool Update(IndexersModel IndexersObj)
        {
            ...
            using (SqlConnection myConnection = GetSqlConnection())
            {
				...
				myCommand.Parameters.Add("@IndexerID", SqlDbType.Int).Value = IndexersObj.IndexerID;
				myCommand.Parameters.Add("@Name", SqlDbType.VarChar).Value = IndexersObj.Name;
				myCommand.Parameters.Add("@OwnerID", SqlDbType.Int).Value = IndexersObj.OwnerID;
        ...
        public bool Delete(int IndexerID)
        {
            ...
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
                if(IndexerID>0)myCommand.Parameters.Add("@IndexerID", SqlDbType.Int).Value = IndexerID;
        ...
        public void DeleteGroupofObjects(int[] ids)
        {
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
                myCommand.Parameters.Add("@IndexerID", SqlDbType.Int);
