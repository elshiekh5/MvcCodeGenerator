    ...
    public class JournalsOwnersSqlDataPrvider
    {
        ...
        public bool Create(JournalsOwnersModel JournalsOwnersObj)
        {
            ...
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
				myCommand.Parameters.Add("@JournalOwner", SqlDbType.Int).Direction = ParameterDirection.Output;
				myCommand.Parameters.Add("@OwnerName", SqlDbType.VarChar).Value = JournalsOwnersObj.OwnerName;
        ...
        public bool Update(JournalsOwnersModel JournalsOwnersObj)
        {
            ...
            using (SqlConnection myConnection = GetSqlConnection())
            {
				...
				myCommand.Parameters.Add("@JournalOwner", SqlDbType.Int).Value = JournalsOwnersObj.JournalOwner;
				myCommand.Parameters.Add("@OwnerName", SqlDbType.VarChar).Value = JournalsOwnersObj.OwnerName;
        ...
        public bool Delete(int JournalOwner)
        {
            ...
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
                if(JournalOwner>0)myCommand.Parameters.Add("@JournalOwner", SqlDbType.Int).Value = JournalOwner;
        ...
        public void DeleteGroupofObjects(int[] ids)
        {
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
                myCommand.Parameters.Add("@JournalOwner", SqlDbType.Int);
