    ...
    public class IndexersOwnersSqlDataPrvider
    {
        ...
        public bool Create(IndexersOwnersModel IndexersOwnersObj)
        {
            ...
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
				myCommand.Parameters.Add("@OwnerID", SqlDbType.Int).Direction = ParameterDirection.Output;
				myCommand.Parameters.Add("@Name", SqlDbType.VarChar).Value = IndexersOwnersObj.Name;
        ...
        public bool Update(IndexersOwnersModel IndexersOwnersObj)
        {
            ...
            using (SqlConnection myConnection = GetSqlConnection())
            {
				...
				myCommand.Parameters.Add("@OwnerID", SqlDbType.Int).Value = IndexersOwnersObj.OwnerID;
				myCommand.Parameters.Add("@Name", SqlDbType.VarChar).Value = IndexersOwnersObj.Name;
        ...
        public bool Delete(int OwnerID)
        {
            ...
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
                if(OwnerID>0)myCommand.Parameters.Add("@OwnerID", SqlDbType.Int).Value = OwnerID;
        ...
        public void DeleteGroupofObjects(int[] ids)
        {
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
                myCommand.Parameters.Add("@OwnerID", SqlDbType.Int);
