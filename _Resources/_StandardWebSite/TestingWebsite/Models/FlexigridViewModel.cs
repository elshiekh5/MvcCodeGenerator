...
namespace TestingWebsite.Models
{
    ...
    public class FlexigridViewModel
    {
        ...
        { }
        public FlexigridViewModel(string id, string url, string dataType, string sortName, string sortOrder, bool usePager, string title, bool useRp, int rp, bool showTableToggleBtn, int width, int height)
        {
            this.ID = id;
            this.Url = url;
