...
namespace CmsTeamSmallLibrary
{
	...
	public class DirectoriesManager
	{
		...
		//--------------------------------------------
        public static void CreateIfNotExistAndCreate(string path)
		{
			if(!Directory.Exists(path))
				Directory.CreateDirectory(path);
		}/*
        #region --------------CheckFoldersFromAndCreateIfNotExist--------------
        //------------------------------------------------------------------------------------------------------
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        //--------------------------------------------------------------------
        public static void CheckFullPathFoldersFromAndCreateIfNotExist(string path)
        {
