    ...
    public class ItemsSqlDataPrvider
    {
        ...
        public bool Create(ItemsModel ItemsObj)
        {
            ...
            using (SqlConnection myConnection = GetSqlConnection())
            {
				...
				myCommand.Parameters.Add("@Description", SqlDbType.NVarChar, -1).Value = ItemsObj.Description;
        ...
        //--------------------------------------------------------------------
        public bool Updat(ItemsModel ItemsObj)
        {
            bool result = false;
            using (SqlConnection myConnection = GetSqlConnection())
            {
        ...
        //--------------------------------------------------------------------
        public List<ItemsModel> GetPageByPage(int pageIndex, int pageSize, out int totalRecords)
        {
            using (SqlConnection myConnection = GetSqlConnection())
            {
                //----------------------------------------------------------------------------------------------
