    ...
    public class StatusSqlDataPrvider
    {
        ...
        public bool Create(StatusModel StatusObj)
        {
            ...
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
				myCommand.Parameters.Add("@StatusID", SqlDbType.Int, 4).Value = StatusObj.StatusID;
				myCommand.Parameters.Add("@Title", SqlDbType.VarChar, 64).Value = StatusObj.Title;
        ...
        public bool Delete(int StatusID)
        {
            ...
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
                if(StatusID>0)myCommand.Parameters.Add("@StatusID", SqlDbType.Int, 4).Value = StatusID;
        ...
        public void DeleteGroupofObjects(int[] ids)
        {
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
                myCommand.Parameters.Add("@StatusID", SqlDbType.Int, 4);
