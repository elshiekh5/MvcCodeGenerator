    ...
    public class JournalsSqlDataPrvider
    {
        ...
        public bool Create(JournalsModel JournalsObj)
        {
            ...
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
				myCommand.Parameters.Add("@JournalCode", SqlDbType.VarChar, 20).Value = JournalsObj.JournalCode;
				myCommand.Parameters.Add("@FullTitle", SqlDbType.VarChar, 255).Value = JournalsObj.FullTitle;
				myCommand.Parameters.Add("@ShortTitle", SqlDbType.VarChar, 255).Value = JournalsObj.ShortTitle;
				myCommand.Parameters.Add("@JournalSubCode", SqlDbType.VarChar, 20).Value = JournalsObj.JournalSubCode;
				myCommand.Parameters.Add("@JournalOwner", SqlDbType.Int, 4).Value = JournalsObj.JournalOwner;
        ...
        public bool Delete(string JournalCode)
        {
            ...
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
                if(!string.IsNullOrEmpty(JournalCode))myCommand.Parameters.Add("@JournalCode", SqlDbType.VarChar, 20).Value = JournalCode;
        ...
        public void DeleteGroupofObjects(string[] ids)
        {
            using (SqlConnection myConnection = GetSqlConnection())
            {
                ...
                // Set the parameters
                //----------------------------------------------------------------------------------------------
                myCommand.Parameters.Add("@JournalCode", SqlDbType.VarChar, 20);
